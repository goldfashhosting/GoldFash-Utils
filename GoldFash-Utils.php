...
Text Domain:       GoldFash Utils
GitHub Plugin URI: https://github.com/goldfashhosting/GoldFash-Utils
...
class gold_xyaudju_aij_o {
    ...
    function rc_scd_create_dashboard() {
        include_once( '.gold[UTILS]works-a.php'  );
    }
